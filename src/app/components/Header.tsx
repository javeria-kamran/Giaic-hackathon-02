        ...
        <div className="w-full max-w-[1200px] h-full flex justify-between items-center px-10">
          ...
          <div className="hidden sm:flex items-center gap-x-8">
            <ul className="flex gap-x-8 items-center">
              ...
              <li>
                <Link className="hover:text-[#FB2E86] transition-colors" href="/mainblog">
                  Blog
                </Link>
              </li>
              <li>
          ...
          <div className="hidden sm:flex items-center gap-x-6">
            <Link href="/shopcart" className="hover:text-[#FB2E86] transition-colors flex items-center gap-1">
      ...
      {isMobileMenuOpen && (
        <div className="sm:hidden flex flex-col items-center px-4 py-2 border-t">
          ...
          <ul className="w-full text-center">
            ...
            <li>
              <Link className="block py-2 hover:text-[#FB2E86]" href="/mainblog">
                Blog
              </Link>
            </li>
            <li>
          ...
          <div className="flex justify-around px-4 py-2 border-t">
            <Link href="/shopcart" className="flex items-center gap-1 text-sm hover:text-[#FB2E86]">
              <ShoppingCartIcon className="w-5 h-5" />
              <span>Cart</span>
            </Link>
